...
assumes that you have already set up a development environment based on the [previous tutorial](starting.md).
<p>&nbsp;</p><p>&nbsp;</p>
...
First, access your development environment using the instructions from the [previous tutorial](starting.md), open the terminal and 
